    ...
    _O.Ctrl = {
      getLists() {
        return [
          {
            name: '',
            imgSrc: 'images/dining_together/01.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/dining_together/02.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/dining_together/03.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/dining_together/04.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/dining_together/05.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/dining_together/06.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/dining_together/07.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/dining_together/08.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/dining_together/09.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/dining_together/10.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/dining_together/11.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/dining_together/12.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/dining_together/13.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/dining_together/14.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/dining_together/15.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/dining_together/16.png',
            selected: false
          }
        ];
      },
        ...
        for(i; i < length && length <= _O.Vars.curRound; i++) {
          ...
          <li>
            <a class="item ${_O.Vars.curRound === 1 ? 'final' : ''}" id="item_${i}" hover="false" href="javascript:void(0);" onclick="lezhin.Event.clickItem(this);" onmouseover="lezhin.Event.overItem(this);" onmouseout="lezhin.Event.outItem(this);">
              <span class="thumb"><img src="${_O.Vars.gameHistory[_O.Vars.curRound.toString()][i]['imgSrc']}" alt="경조사"></span>
