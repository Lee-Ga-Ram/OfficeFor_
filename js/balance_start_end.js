    ...
    _O.Ctrl = {
      getLists() {
        return [
          {
            name: '',
            imgSrc: 'images/start_end/01.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/start_end/02.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/start_end/03.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/start_end/04.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/start_end/05.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/start_end/06.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/start_end/07.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/start_end/08.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/start_end/09.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/start_end/10.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/start_end/11.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/start_end/12.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/start_end/13.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/start_end/14.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/start_end/15.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/start_end/16.png',
            selected: false
          }
        ];
      },
        ...
        for(i; i < length && length <= _O.Vars.curRound; i++) {
          ...
          <li>
            <a class="item ${_O.Vars.curRound === 1 ? 'final' : ''}" id="item_${i}" hover="false" href="javascript:void(0);" onclick="lezhin.Event.clickItem(this);" onmouseover="lezhin.Event.overItem(this);" onmouseout="lezhin.Event.outItem(this);">
              <span class="thumb"><img src="${_O.Vars.gameHistory[_O.Vars.curRound.toString()][i]['imgSrc']}" alt="출퇴근"></span>
