    ...
    _O.Ctrl = {
      getLists() {
        return [
          {
            name: '',
            imgSrc: 'images/meeting/01.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/meeting/02.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/meeting/03.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/meeting/04.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/meeting/05.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/meeting/06.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/meeting/07.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/meeting/08.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/meeting/09.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/meeting/10.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/meeting/11.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/meeting/12.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/meeting/13.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/meeting/14.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/meeting/15.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/meeting/16.png',
            selected: false
          }
        ];
      },
        ...
        for(i; i < length && length <= _O.Vars.curRound; i++) {
          ...
          <li>
            <a class="item ${_O.Vars.curRound === 1 ? 'final' : ''}" id="item_${i}" hover="false" href="javascript:void(0);" onclick="lezhin.Event.clickItem(this);" onmouseover="lezhin.Event.overItem(this);" onmouseout="lezhin.Event.outItem(this);">
              <span class="thumb"><img src="${_O.Vars.gameHistory[_O.Vars.curRound.toString()][i]['imgSrc']}" alt="회의"></span>
