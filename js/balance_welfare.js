    ...
    _O.Ctrl = {
      getLists() {
        return [
          {
            name: '',
            imgSrc: 'images/welfare/01.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/welfare/02.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/welfare/03.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/welfare/04.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/welfare/05.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/welfare/06.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/welfare/07.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/welfare/08.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/welfare/09.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/welfare/10.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/welfare/11.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/welfare/12.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/welfare/13.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/welfare/14.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/welfare/15.png',
            selected: false
          },
          {
            name: '',
            imgSrc: 'images/welfare/16.png',
            selected: false
          }
        ];
      },
        ...
        for(i; i < length && length <= _O.Vars.curRound; i++) {
          ...
          <li>
            <a class="item ${_O.Vars.curRound === 1 ? 'final' : ''}" id="item_${i}" hover="false" href="javascript:void(0);" onclick="lezhin.Event.clickItem(this);" onmouseover="lezhin.Event.overItem(this);" onmouseout="lezhin.Event.outItem(this);">
              <span class="thumb"><img src="${_O.Vars.gameHistory[_O.Vars.curRound.toString()][i]['imgSrc']}" alt="복지"></span>
