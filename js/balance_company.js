    ...
    _O.Ctrl = {
      getLists() {
        return [
          {
            name: ' ',
            imgSrc: 'images/company/01.png',
            selected: false
          },
          {
            name: ' ',
            imgSrc: 'images/company/02.png',
            selected: false
          },
          {
            name: ' ',
            imgSrc: 'images/company/03.png',
            selected: false
          },
          {
            name: ' ',
            imgSrc: 'images/company/04.png',
            selected: false
          },
          {
            name: ' ',
            imgSrc: 'images/company/05.png',
            selected: false
          },
          {
            name: ' ',
            imgSrc: 'images/company/06.png',
            selected: false
          },
          {
            name: ' ',
            imgSrc: 'images/company/07.png',
            selected: false
          },
          {
            name: ' ',
            imgSrc: 'images/company/08.png',
            selected: false
          },
          {
            name: ' ',
            imgSrc: 'images/company/09.png',
            selected: false
          },
          {
            name: ' ',
            imgSrc: 'images/company/10.png',
            selected: false
          },
          {
            name: ' ',
            imgSrc: 'images/company/11.png',
            selected: false
          },
          {
            name: ' ',
            imgSrc: 'images/company/12.png',
            selected: false
          },
          {
            name: ' ',
            imgSrc: 'images/company/13.png',
            selected: false
          },
          {
            name: ' ',
            imgSrc: 'images/company/14.png',
            selected: false
          },
          {
            name: ' ',
            imgSrc: 'images/company/15.png',
            selected: false
          },
          {
            name: ' ',
            imgSrc: 'images/company/16.png',
            selected: false
          }
        ];
      },
        ...
        for(i; i < length && length <= _O.Vars.curRound; i++) {
          ...
          <li>
            <a class="item ${_O.Vars.curRound === 1 ? 'final' : ''}" id="item_${i}" hover="false" href="javascript:void(0);" onclick="lezhin.Event.clickItem(this);" onmouseover="lezhin.Event.overItem(this);" onmouseout="lezhin.Event.outItem(this);">
              <span class="thumb"><img src="${_O.Vars.gameHistory[_O.Vars.curRound.toString()][i]['imgSrc']}" alt="회사"></span>
